...
export default function page() {
    return (
        <section>
            <div className=' relative flex  px-4 lg:px-0 flex-col justify-end h-[30rem] lg:h-[23rem] overflow-hidden w-full'>
                <motion.div
            ...
            <div className='mx-auto lg:w-[80rem]  px-4 lg:px-0 '>
                <div className='py-16 border-b'>
                    ...
                    <div className=' mt-9 flex lg:flex-row flex-col gap-5'>
                        <button className="group/button justify-between w-full sm:w-auto relative inline-flex items-center gap-1 overflow-hidden rounded-xl bg-white/80 px-5 py-2.5 font-semibold text-black duration-300 hover:bg-white">
                        ...
                        <button className="group/button relative w-full justify-between sm:w-auto inline-flex items-center gap-1 overflow-hidden rounded-xl  px-5 py-2.5 font-semibold text-white duration-300 hover:bg-black border border-white">
                ...
                <div className=' h-screen  border-b relative overflow-hidden grid lg:grid-cols-2 place-items-center '>
                    ...
                    <div className=' mt-40 md:mt-0'>
                        <div
                            ...
                            className=" h-[30rem] lg:h-[44rem] absolute -right-[100rem] top-[60%] -translate-y-1/2 flex items-center justify-center">
