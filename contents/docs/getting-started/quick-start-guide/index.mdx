...
- Make sure to add the following frontmatter to format data for the blogs properly:
  ...
  description: "Grok is an AI modeled after the Hitchhiker’s Guide to the Galaxy. It is intended to answer almost anything and, far harder, even suggest what questions to ask!"
  date: 02-09-2024
  authors:
